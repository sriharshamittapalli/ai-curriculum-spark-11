...
import { BookOpen, Video, FileText, Sparkles, PlusCircle, Code, X } from "lucide-react";
import { z } from "zod";
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} value={field.value}>
                      <FormControl>
                        <SelectTrigger className="w-full border-gray-200 bg-white rounded-lg px-4 py-2 h-12 text-gray-700 hover:border-blue-400 transition-all shadow-sm hover:shadow focus:ring-blue-200 focus:border-blue-500">
                          <SelectValue placeholder="Select learning pace" className="text-gray-500" />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent className="bg-white rounded-xl border border-gray-100 shadow-lg">
                        <SelectItem value="1-week" className="hover:bg-gray-50 cursor-pointer py-2 px-2 rounded-md focus:bg-gray-50 text-gray-700">
                          <div className="flex items-center gap-2">
                            <div className="w-6 text-blue-500">📆</div>
                            1 Week
                          </div>
                        </SelectItem>
                        <SelectItem value="2-weeks" className="hover:bg-gray-50 cursor-pointer py-2 px-2 rounded-md focus:bg-gray-50 text-gray-700">
                          <div className="flex items-center gap-2">
                            <div className="w-6 text-purple-500">📆</div>
                            2 Weeks
                          </div>
                        </SelectItem>
                        <SelectItem value="1-month" className="hover:bg-gray-50 cursor-pointer py-2 px-2 rounded-md focus:bg-gray-50 text-gray-700">
                          <div className="flex items-center gap-2">
                            <div className="w-6 text-orange-500">📆</div>
                            1 Month
                          </div>
                        </SelectItem>
                        <SelectItem value="3-months" className="hover:bg-gray-50 cursor-pointer py-2 px-2 rounded-md focus:bg-gray-50 text-gray-700">
                          <div className="flex items-center gap-2">
                            <div className="w-6 text-pink-500">📆</div>
                            3 Months
                          </div>
                        </SelectItem>
                        <SelectItem value="6-months" className="hover:bg-gray-50 cursor-pointer py-2 px-2 rounded-md focus:bg-gray-50 text-gray-700">
                          <div className="flex items-center gap-2">
                            <div className="w-6 text-teal-500">📆</div>
                            6 Months
                          </div>
                        </SelectItem>
                      </SelectContent>
