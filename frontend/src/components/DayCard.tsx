  ...
  return (
    ...
    >
      <Card className={`overflow-hidden rounded-lg ${
        completed ? "ring-1 ring-blue-500/20 shadow-md border-blue-500/10" : "border-gray-200 shadow-sm"
      }`}>
        ...
        <CardContent className="px-6 space-y-5">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {resources.map((resource, index) => (
                <motion.li 
                  key={index} 
                  className="p-3 rounded-lg border border-gray-100 bg-gray-50 hover:bg-white hover:border-gray-200 transition-all hover:shadow-md"
          ...
          <div>
            ...
            <motion.div 
              className="text-sm text-gray-700 p-4 bg-green-50 rounded-lg border border-green-100"
              whileHover={{ y: -2 }}
              transition={{ type: "spring", stiffness: 300 }}
            >
              {assignment}
        ...
        <CardFooter className="p-6 pt-2">
          <Button 
            ...
            className={`w-full ${completed 
              ? "border-green-200 text-green-600 hover:bg-green-50 rounded-lg py-5" 
              : "bg-gradient-to-r from-custom-blue to-custom-light-blue hover:opacity-90 text-white shadow-md hover:shadow-lg rounded-lg py-5 group"
