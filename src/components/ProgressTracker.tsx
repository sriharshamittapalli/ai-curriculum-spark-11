  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-start mb-3">
        ...
        <motion.div 
          className="text-lg font-bold text-custom-blue flex items-center gap-2"
          key={displayProgress}
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <AnimatePresence>
          {completedDays.length > 0 && (
            <motion.div 
              className="flex items-center gap-1.5 text-xs bg-yellow-50 text-yellow-700 px-2.5 py-1 rounded-full border border-yellow-100"
              initial={{ opacity: 0, scale: 0.8 }}
