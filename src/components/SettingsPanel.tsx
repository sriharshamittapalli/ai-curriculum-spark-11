...
const SettingsPanel: React.FC<SettingsPanelProps> = ({
  ...
  return (
    <div className="glass-card h-full flex flex-col border border-gray-100 rounded-3xl bg-white/95 backdrop-blur-sm shadow-xl">
      ...
      <ScrollArea className="flex-grow px-8 pb-8 overflow-y-auto max-h-[calc(100vh-220px)]">
        <Form {...form}>
